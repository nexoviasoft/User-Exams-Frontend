    ...
    <DashboardLayout>
      <div className="space-y-8 max-w-7xl mx-auto pb-20">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            <h1 className="text-3xl font-display font-bold tracking-tight">Exam Types 🎓</h1>
            <p className="text-text-secondary mt-1">Manage platform exam categories and types.</p>
          </div>
                 ...
                 <form onSubmit={handleAddSubmit} className="space-y-4 mt-4">
                   <div className="space-y-2">
                     ...
                     <input
                       ...
                       placeholder="e.g. Board Exam, Admission Test"
                     />
                   </div>
                   <div className="space-y-2">
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-border">
                {isLoading ? (
                  ...
                  <tr>
                    <td colSpan={4} className="px-6 py-8 text-center text-text-secondary">
                      No exam types found. Add a new one.
                    </td>
                  </tr>
                ) : (
