...
import { Trophy, Clock, Loader2, ArrowLeft, Medal, User, Crown, Star, Calendar, BookOpen } from 'lucide-react';
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="space-y-1">
              ...
              <p className="text-text-secondary font-medium flex items-center gap-2">
                <BookOpen className="w-4 h-4 text-primary" /> বিষয়ের শীর্ষ ১০০ মেধাবী
              </p>
            </div>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center p-20 bg-bg-card/40 backdrop-blur-xl rounded-[32px] border-2 border-dashed border-border/50 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-text-secondary font-medium max-w-xs mx-auto">এখনো কেউ এই বিষয়টি সম্পন্ন করেনি।</p>
            </div>
          </div>
        ) : (
