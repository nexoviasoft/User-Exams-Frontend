    ...
    <DashboardLayout>
      <div className="max-w-6xl mx-auto space-y-6 pb-20">
        <div className="flex items-center justify-between gap-3">
          <div>
            <h1 className="text-2xl font-bold">{modelTestName} - Exams</h1>
            <p className="text-text-secondary text-sm">এই Model Test এর under সব exams</p>
          </div>
          <Link href="/teacher/model-tests">
            <Button variant="outline">Back to Model Tests</Button>
          </Link>
        </div>
        ...
        <Card className="border-border bg-bg-card/50">
          ...
          <CardContent className="space-y-3">
            {isLoading ? (
              ...
              <p className="text-sm text-text-secondary">এই model test-এর জন্য কোনো exam পাওয়া যায়নি।</p>
            ) : (
